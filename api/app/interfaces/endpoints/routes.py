...
from . import status_routes,app_config_routes,file_routes,session_routes,auth_routes,knowledge_routes,tenant_llm_routes,tenant_notify_routes,tenant_search_routes,membership_routes,enterprise_profile_routes,agent_memory_routes,policy_routes,feed_routes,qualification_routes,report_routes,briefing_routes,contest_routes,feishu_integration_routes
...
def create_api_routes() -> APIRouter:
    ...
    api_router.include_router(tenant_notify_routes.router)
    api_router.include_router(feishu_integration_routes.router)
    api_router.include_router(tenant_search_routes.router)
