        ...
        <FieldSet>
          ...
          <FieldGroup>
            ...
            <Field>
              ...
              />
              <FieldDescription className="text-xs">
                请填写 GoodManus 调用的模型名字，模型必须支持工具调用、图像识别等功能。
              </FieldDescription>
            </Field>
            <Field>
      ...
      <FieldGroup>
        <FieldSet>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-gray-500">
                    GoodManus 使用标准的 A2A 协议来连接远程 Agent。
                    <br/>
          ...
          <FieldDescription className="text-sm">
            模型上下文协议 (MCP) 通过集成外部工具来增强 GoodManus 的性能，例如私有域搜索、网页浏览、订餐、PPT 生成等任务。
          </FieldDescription>
            ...
            <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-gray-500">
                    GoodManus 使用标准的 JSON MCP 配置来创建新服务器。
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="!max-w-[850px]">
        ...
        <DialogHeader className="border-b pb-4">
          <DialogTitle className="text-gray-700">GoodManus 设置</DialogTitle>
          <DialogDescription className="text-gray-500">在此管理您的 GoodManus 设置。</DialogDescription>
        </DialogHeader>
