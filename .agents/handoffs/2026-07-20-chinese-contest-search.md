...
- 扩大到赛事爬虫/Feed 共 57 项：**50 passed / 7 failed**。7 项均在未修改的 Feed 测试，固定
  `publish_date=2026-06-01` 到当前 2026-07-20 已 49 天，超过产品现有“无明确截止赛事最多 45 天”规则；
  属测试夹具随日期失效，不是本分支回归。本任务未顺手改动该无关测试。
- `git diff --check`：通过。
